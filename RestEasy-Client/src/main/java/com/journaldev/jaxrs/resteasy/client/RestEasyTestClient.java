...
public class RestEasyTestClient {
	...
	public static void main(String[] args) {
		...
		/*//GET example
		ResteasyWebTarget getDummy = client.target("http://localhost:8091/RestEasyApp/employee/1/getDummy");
      ...
      //POST example
		ResteasyWebTarget add = client.target("http://localhost:8091/RestEasyApp/employee/add");
		...
		addResponse.close();
		  /*
		//DELETE example
		ResteasyWebTarget delete = client.target("http://localhost:8091/RestEasyApp/employee/111/delete");
